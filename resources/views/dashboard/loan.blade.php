...
<div class="content-body">
    ...
    <div class="container-fluid">
        ...
        <div class="my-4">
            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#reqLoan">Request Loan
                <span class="btn-icon-end"><i class="fa fa-star"></i></span>
            </button>
        </div>
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="d-sm-flex  d-block align-items-center mb-4">
                    <div class="me-auto">
                        ...
                        <span class="fs-12"><i class="flaticon-381-help-1"></i>&nbsp;Loans are only offered to existing
                            and eligible customers</span>
                    </div>
                    ...
                    <table class="table display mb-4 dataTablesCard " id="example5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="text-black font-w500">$ 600</span></td>
